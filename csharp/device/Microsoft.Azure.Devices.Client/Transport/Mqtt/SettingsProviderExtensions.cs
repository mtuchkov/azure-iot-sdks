...
namespace Microsoft.Azure.Devices.Client.Transport.Mqtt
{
    ...
    public static class SettingsProviderExtensions
    {
        ...
        public static ulong GetULongSetting(this ISettingsProvider settingsProvider, string name, ulong? defaultValue = null)
        {
            ulong result;
            if (TryGetULongSetting(settingsProvider, name, out result))
            {
                return result;
            }
        ...
        public static bool TryGetULongSetting(this ISettingsProvider settingsProvider, string name, out ulong result)
        {
            string value;
            if (!settingsProvider.TryGetSetting(name, out value))
            {
        ...
        public static T GetEnumSetting<T>(this ISettingsProvider settingsProvider, string name, T defaultValue = default(T)) where T : struct
        {
            T result;
            if (TryGetEnum(settingsProvider, name, out result))
            {
                return result;
            }
            return defaultValue;
        ...
        public static bool TryGetEnum<T>(this ISettingsProvider settingsProvider, string name, out T result) where T : struct
        {
            string value;
            if (settingsProvider.TryGetSetting(name, out value) && Enum.TryParse(value, out result))
            {
                return true;
            }
            result = default(T);
